...
$config['database']['database'] = 'bincpw_bap';
$config['database']['table_prefix'] = 'mybb6a_';

$config['database']['hostname'] = 'localhost';
$config['database']['username'] = 'bincpw_forum';
$config['database']['password'] = 'cdaaptnia16';
