...
/* + PL:style_your_nick + */ 
/* + PL:style_your_nick + */ static $users;
/* + PL:style_your_nick + */ 
/* + PL:style_your_nick + */ if(!is_array($users))
/* + PL:style_your_nick + */ {
/* + PL:style_your_nick + */ 	global $db;
/* + PL:style_your_nick + */ 	
/* + PL:style_your_nick + */ 	$usedefgids = $users = array();
/* + PL:style_your_nick + */ 	
/* + PL:style_your_nick + */ 	foreach($groupscache as $g)
/* + PL:style_your_nick + */ 		if(!$g["syn_usedefault"])
/* + PL:style_your_nick + */ 			$usedefgids[] = $g["gid"];
/* + PL:style_your_nick + */ 	
/* + PL:style_your_nick + */ 	// If there are no usergroups with removed default styling, use a simplier query
/* + PL:style_your_nick + */ 	if(empty($usedefgids))
/* + PL:style_your_nick + */ 		$q = $db->query("SELECT u.username, u.usergroup, u.additionalgroups, s.*
/* + PL:style_your_nick + */ 			FROM {$db->table_prefix}styleyournick s
/* + PL:style_your_nick + */ 			LEFT JOIN {$db->table_prefix}users u ON(u.uid = s.uid)
/* + PL:style_your_nick + */ 		");
/* + PL:style_your_nick + */ 	else
/* + PL:style_your_nick + */ 		$q = $db->query("SELECT u.username, u.usergroup, u.additionalgroups, s.*
/* + PL:style_your_nick + */ 			FROM {$db->table_prefix}users u
/* + PL:style_your_nick + */ 			LEFT JOIN {$db->table_prefix}styleyournick s ON(s.uid = u.uid)
/* + PL:style_your_nick + */ 		");	
/* + PL:style_your_nick + */ 
/* + PL:style_your_nick + */ 	while($u = $db->fetch_array($q))
/* + PL:style_your_nick + */ 	{
/* + PL:style_your_nick + */ 		if($u["additionalgroups"])
/* + PL:style_your_nick + */ 			$u["usergroup"] .= ",".$u["additionalgroups"];
/* + PL:style_your_nick + */ 		
/* + PL:style_your_nick + */ 		$perms = usergroup_permissions($u["usergroup"]);
/* + PL:style_your_nick + */ 		
/* + PL:style_your_nick + */ 		if($perms["syn_style"])
/* + PL:style_your_nick + */ 			$users[$u["username"]] = array_merge($perms, $u);
/* + PL:style_your_nick + */ 	}
/* + PL:style_your_nick + */ }
/* + PL:style_your_nick + */ 
/* + PL:style_your_nick + */ if(isset($users[$username]) && $usergroup != 1)
/* + PL:style_your_nick + */ {
/* + PL:style_your_nick + */ 	global $mybb;
/* + PL:style_your_nick + */ 	
/* + PL:style_your_nick + */ 	$u = $users[$username];
/* + PL:style_your_nick + */ 	$style = "";
/* + PL:style_your_nick + */ 	
/* + PL:style_your_nick + */ 	if($u["color"] && $u["syn_cancolor"] && style_your_nick_validate_color($u["color"], $mybb->settings["style_your_nick_transparent"]))
/* + PL:style_your_nick + */ 		$style .= "color: ".htmlspecialchars_uni($u["color"])."; ";
/* + PL:style_your_nick + */ 	
/* + PL:style_your_nick + */ 	if($u["background"] && $u["syn_canbackground"] && style_your_nick_validate_color($u["background"], $mybb->settings["style_your_nick_transparent"]))
/* + PL:style_your_nick + */ 		$style .= "background-color: ".htmlspecialchars_uni($u["background"])."; ";
/* + PL:style_your_nick + */ 	
/* + PL:style_your_nick + */ 	// No size checks unfortunately since they are way too slow or unreliable... Unless I would upload all images to server, which may happen in the future.
/* + PL:style_your_nick + */ 	if($u["backgroundimg"] && $u["syn_canbackgroundimg"])
/* + PL:style_your_nick + */ 	{
/* + PL:style_your_nick + */ 		$style .= "background-image: url(".htmlspecialchars_uni($u["backgroundimg"])."); ";
/* + PL:style_your_nick + */ 		
/* + PL:style_your_nick + */ 		if($u["backgroundrepeat"] && $u["syn_canbackgroundrepeat"])
/* + PL:style_your_nick + */ 			$style .= "background-repeat: repeat; ";
/* + PL:style_your_nick + */ 	}
/* + PL:style_your_nick + */ 	
/* + PL:style_your_nick + */ 	if($u["size"] && $u["syn_cansize"] && style_your_nick_validate_size($u["size"], $mybb->settings["style_your_nick_max_font"], $mybb->settings["style_your_nick_min_font"]))
/* + PL:style_your_nick + */ 		$style .= "font-size: ".htmlspecialchars_uni($u["size"])."; ";
/* + PL:style_your_nick + */ 	
/* + PL:style_your_nick + */ 	if($u["bold"] && $u["syn_canbold"])
/* + PL:style_your_nick + */ 		$style .= "font-weight: bold; ";
/* + PL:style_your_nick + */ 	
/* + PL:style_your_nick + */ 	if($u["italic"] && $u["syn_canitalic"])
/* + PL:style_your_nick + */ 		$style .= "font-style: italic; ";
/* + PL:style_your_nick + */ 	
/* + PL:style_your_nick + */ 	if($u["underline"] && $u["syn_canunderline"])
/* + PL:style_your_nick + */ 		$under = " underline";
/* + PL:style_your_nick + */ 	
/* + PL:style_your_nick + */ 	if($u["overline"] && $u["syn_canoverline"])
/* + PL:style_your_nick + */ 		$over = " overline";
/* + PL:style_your_nick + */ 	
/* + PL:style_your_nick + */ 	if($u["strike"] && $u["syn_canstrike"])
/* + PL:style_your_nick + */ 		$through = " line-through";
/* + PL:style_your_nick + */ 	
/* + PL:style_your_nick + */ 	if($under || $through || $over)
/* + PL:style_your_nick + */ 		$style .= "text-decoration: $under$over$through; ";
/* + PL:style_your_nick + */ 	
/* + PL:style_your_nick + */ 	if($u["capitalize"] && $u["syn_cancapitalize"])
/* + PL:style_your_nick + */ 		$style .= "text-transform: capitalize; ";
/* + PL:style_your_nick + */ 	
/* + PL:style_your_nick + */ 	if($u["shadowx"] && $u["shadowy"] && $u["syn_canshadow"] && style_your_nick_validate_size($u["shadowx"], $mybb->settings["style_your_nick_max_shadowx"], $mybb->settings["style_your_nick_min_shadowx"])
/* + PL:style_your_nick + */ 	&& style_your_nick_validate_size($u["shadowy"], $mybb->settings["style_your_nick_max_shadowy"], $mybb->settings["style_your_nick_min_shadowy"]))
/* + PL:style_your_nick + */ 	{
/* + PL:style_your_nick + */ 		$length = $u["shadowlength"] && style_your_nick_validate_size($u["shadowlength"], $mybb->settings["style_your_nick_max_shadowlength"], $mybb->settings["style_your_nick_min_shadowlength"])
/* + PL:style_your_nick + */ 				? " ".htmlspecialchars_uni($u["shadowlength"])
/* + PL:style_your_nick + */ 				: "";
/* + PL:style_your_nick + */ 		$color = $u["shadowcolor"] && style_your_nick_validate_color($u["shadowcolor"], $mybb->settings["style_your_nick_transparent"])
/* + PL:style_your_nick + */ 				? " ".htmlspecialchars_uni($u["shadowcolor"])
/* + PL:style_your_nick + */ 				: "";
/* + PL:style_your_nick + */ 		$style .= "text-shadow: ".htmlspecialchars_uni($u["shadowx"])." ".htmlspecialchars_uni($u["shadowy"])."$length$color; ";
/* + PL:style_your_nick + */ 	}
/* + PL:style_your_nick + */ 	
...
/* + PL:style_your_nick + */ 		$format = "{username}";
/* + PL:style_your_nick + */ }
