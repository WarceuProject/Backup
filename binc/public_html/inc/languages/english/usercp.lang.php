...
$l['referral_link'] = "{1}/member.php?action=register&amp;referrer={2}";
$l['referral_link_original'] = "<br />To refer a member to this board, direct them to {1}/member.php?action=register&amp;referrer={2}";
