...
<div class="wrapper">
  ...
  <style>
   ...
   <li><a href="addcounter.php">
          ...
          <li><a href="pm.php">
				  <i class="fa  fa-cog"></i> Perfect Money</a>
          </li>
          <li><a href="coinpayment.php">
				  <i class="fa  fa-cog"></i> Coinpayment</a>
          </li>
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="ivtpackages.php"><i class="fa fa-users"></i> Investors Investment </a></li>
