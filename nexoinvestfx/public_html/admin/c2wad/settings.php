...
if(isset($_POST['uset'])){
 ...
 if($logo!=""){
    $sql = "UPDATE settings SET  sname='$sname', bname='$bname', email='$email', mw='$mw', title='$title', logo='$logo', cy='$scy' WHERE id = '$ids' ";
    }else{
    $sql = "UPDATE settings SET  sname='$sname', bname='$bname', email='$email', mw='$mw', title='$title', cy='$scy' WHERE id = '$ids' ";
    }
